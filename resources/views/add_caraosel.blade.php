...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('caraosel.store') }}" method="POST" class="border p-5 shadow-sm bg-body-tertiary rounded" enctype="multipart/form-data">
            @csrf

            <!-- Text input for Carousel Title -->
            <div class="mb-4">
                <div class="form-outline">
                    <input type="text" id="heroTitle" name="heroTitle" class="form-control" placeholder="Carousel Title">
                    <label class="form-label" for="heroTitle">Carousel Title</label>
                </div>
            </div>
            ...
            <div class="mb-4">
                <div class="form-outline">
                    <input type="file" id="heroImage" name="heroImage" class="form-control">
                    <label class="form-label" for="heroImage">Carousel Image</label>
                </div>
            </div>
            ...
            <!-- Submit button -->
            <button type="submit" class="btn btn-primary btn-block">Add Carousel</button>
        </form>
    </div>
    @endsection
</body>
